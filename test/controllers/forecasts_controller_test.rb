...
class ForecastsControllerTest < ActionController::TestCase
  ...
  test "should create forecast" do
    assert_difference('Forecast.count') do
      post :create, forecast: { amount: @forecast.amount, budget_id: @forecast.budget_id, period_id: @forecast.period_id }
    end
  ...
  test "should update forecast" do
    patch :update, id: @forecast, forecast: { amount: @forecast.amount, budget_id: @forecast.budget_id, period_id: @forecast.period_id }
    assert_redirected_to forecast_path(assigns(:forecast))
  end
